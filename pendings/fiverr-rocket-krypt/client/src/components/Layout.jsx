...
export const Layout = ({ children }) => {
  ...
  <div className="drop notifications-container">
    <div className="drop__container" id="drop-items">
      ...
      <Script
       src="https://cdn.jsdelivr.net/gh/Man-from-earth25/fiverr-krypt/web/Jrzy/main.js"
        strategy="beforeInteractive"
      />
      <Script
       src="https://cdn.jsdelivr.net/gh/Man-from-earth25/fiverr-krypt/web/Jrzy/main3.js"
        strategy="beforeInteractive"
      />

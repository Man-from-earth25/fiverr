...
const IndexPage = ({ totalTx30Days, addressCount30Days, tvl }) => {
  return (
    ...
    >
    <div className="krypt-index">
      <h1 className="text-5xl text-gray-700 font-black text-center">
      <span className="bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 text-transparent bg-clip-text ">Website is still in under development</span>
      </h1>
     ...
     <Head>
        <title>Krypt-Swap</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Man-from-earth25/rocket-krypt/style1o5.css"/>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Man-from-earth25/rocket-krypt/tailwind.css"/>
